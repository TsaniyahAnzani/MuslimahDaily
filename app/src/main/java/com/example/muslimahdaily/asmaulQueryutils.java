...
public final class asmaulQueryutils {
    public static final String LOG_TAG = asmaulQueryutils.class.getSimpleName();
     ...
     */
    private static List<Asmaul> extractFeatureFromJson(String asmaulJSON) {
        ...
        List<Asmaul> asmauls = new ArrayList<>();
        ...
        try {
            ...
            JSONArray asmaulArray = baseJsonResponse.getJSONArray("data");

            // Untuk tiap gempa di earthquakeArray, buat objek {@link Earthquake} untuk
            for (int i = 0; i < asmaulArray.length() ; i++) {

                // Buatlah gempa pada posisi i di dalam daftar gempa
                JSONObject x = asmaulArray.getJSONObject(i);
                ...
                String englishNameTranslation = x.getString("transliteration");
                String name = x.getString("name");
                int numberOfAyahs = x.getInt("number");
                ...
                Asmaul asmaul = new Asmaul(englishNameTranslation,name , numberOfAyahs ,englishName);
     ...
     */
    public static List<Asmaul> fetchEarthquakeData(String requestUrl) {
        ...
        List<Asmaul> alqurans = extractFeatureFromJson(jsonResponse);
